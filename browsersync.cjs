...
browserSync.watch(["./app/**/*.js"], async function (event, file) {
  if (event === "change") {
    await buildJsBundle();
    await pretty();
  }
...
browserSync.watch(["./app/**/*.css"], async function (event, file) {
  if (event === "change") {
...
browserSync.watch(["./app/**/*.html"], async function (event, file) {
